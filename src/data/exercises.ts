...
const EXERCISES_BY_SPORT: Record<SportId, Exercise[]> = {
  ...
  },
  {
    ...
    subtitle: 'Simultaneous two-ball control',
    categories: ['dribbling'],
    durationMinutes: 6,
    goal: 'Both hands working independently at the same time — a real step up from one-ball control.',
    groups: ['u10'],
    steps: [
      'Give each player two balls, one per hand.',
      'Dribble both balls at the same height and same rhythm, standing still first.',
      'Progress to alternating rhythm: one ball up while the other is down.',
      'Add movement: walk forward while keeping both balls under control.',
      'Challenge: dribble both balls while walking a zig-zag path around cones.',
    ],
    cues: [
      { nl: 'Twee ballen, één ritme', en: 'Two balls, one rhythm' },
      { nl: 'Ogen omhoog', en: 'Eyes up' },
    ],
  },
  {
    id: 'dribble-under-pressure',
    emoji: '🥊',
    title: 'Dribble under pressure',
    subtitle: 'Live 1v1 ball protection',
    categories: ['dribbling', 'agility'],
    durationMinutes: 8,
    goal: 'Keep control of the ball with a real defender actively trying to poke it away.',
    groups: ['u10'],
    steps: [
      'Pair up: one player dribbles inside a small grid, the other plays live defense trying to poke the ball away (no grabbing or fouling).',
      'Ball-handler protects the ball with their body, changes hands and speed to keep the defender off balance.',
      '30 seconds per turn, then switch roles.',
      'Coach calls out a bigger or smaller grid to raise or lower the difficulty.',
      'Progression: award a point to the defender for a clean strip, and to the dribbler for surviving the full 30 seconds.',
    ],
    cues: [
      { nl: 'Bal beschermen', en: 'Protect the ball' },
      { nl: 'Verander van snelheid', en: 'Change speed' },
    ],
  },
  {
    id: 'passing-partners',
  ...
  {
    id: 'give-and-go-passing',
    emoji: '🔁',
    title: 'Give-and-go passing',
    subtitle: 'Pass, cut, receive it back',
    categories: ['passing', 'teamplay'],
    durationMinutes: 8,
    goal: 'Passing combined with movement — pass and actually go somewhere, instead of passing and standing still.',
    groups: ['u10'],
    steps: [
      'Two lines face each other, one ball. Passer passes, then sprints toward the receiver\'s line.',
      'Receiver catches, immediately passes back to the now-moving cutter (a hand-off or quick chest pass), then follows their own pass.',
      'Keep the ball moving continuously — no standing and holding it.',
      'Progression: add a defender shadowing the cutter without contesting the pass, just to add game realism.',
      'Challenge: how many completed give-and-goes in 60 seconds without a drop?',
    ],
    cues: [
      { nl: 'Geef en ga!', en: 'Give and go!' },
      { nl: 'Blijf bewegen', en: 'Keep moving' },
    ],
  },
  {
    id: 'shooting-form-progression',
    emoji: '📐',
    title: 'Shooting form progression',
    subtitle: 'BEEF mechanics, increasing distance',
    categories: ['shooting'],
    durationMinutes: 10,
    goal: 'Proper shooting mechanics (Balance, Eyes, Elbow, Follow-through), not just getting the ball in.',
    groups: ['u10'],
    steps: [
      'Start right under the basket with one-hand form shots: balance on both feet, elbow under the ball, snap the wrist on release, hold the follow-through.',
      'Coach checks each player\'s elbow and follow-through before letting them move back.',
      'Once form is consistent, step back to the first floor marker and shoot with two hands.',
      'Keep stepping back one marker at a time, only once a player makes 3 in a row from the current spot.',
      'Track each player\'s furthest "form-approved" distance for next time.',
    ],
    cues: [
      { nl: 'Elleboog eronder', en: 'Elbow underneath' },
      { nl: 'Volg door', en: 'Follow through' },
    ],
  },
  {
  ...
  },
  {
    id: 'closeout-defense',
    emoji: '🙅',
    title: 'Closeout defense',
    subtitle: 'Sprint, chop, contest',
    categories: ['defense', 'agility'],
    durationMinutes: 7,
    goal: 'A real defensive skill — closing the distance to a shooter under control and contesting without fouling.',
    groups: ['u10'],
    steps: [
      'Defender starts under the basket, offensive player waits at the three-point line or floor marker with the ball.',
      'Coach passes to the offensive player; the defender sprints out, then "chops" their feet into a low stance the last two steps — no charging in off balance.',
      'Contest with a high hand, staying low and balanced, without fouling the shooter\'s arm.',
      'If the shot goes up, box out and go get the rebound.',
      'Rotate through every player on both offense and defense.',
    ],
    cues: [
      { nl: 'Sprint, hak, hak', en: 'Sprint, chop, chop' },
      { nl: 'Hoge hand, geen contact', en: 'High hand, no contact' },
    ],
  },
  {
    id: 'live-3v3-halfcourt',
    emoji: '🏆',
    title: 'Live 3v3 half-court',
    subtitle: 'Real baskets, live (light-contact) defense',
    categories: ['teamplay', 'defense', 'passing', 'shooting'],
    durationMinutes: 10,
    goal: 'Actual game play with real rules — live defense and real scoring, not end-zone passing.',
    groups: ['u10'],
    steps: [
      'Play 3v3 half-court to a real basket, normal basketball rules (travels, double dribble called lightly, no reaching-in fouls).',
      'Defenders may contest shots and passing lanes but no grabbing or hand-checking.',
      'Make it call your own fouls — this age can start handling that responsibility.',
      'Play to a low target score (e.g. first to 7) so groups rotate through quickly.',
      'Coach steps back and only intervenes for safety or to reset an argument, letting the game teach itself.',
    ],
    cues: [
      { nl: 'Speel eerlijk', en: 'Play fair' },
      { nl: 'Kom terug in verdediging', en: 'Get back on defense' },
    ],
  },
  {
    id: 'team-finish',
