...
/**
 * Only one club exists today (Sata Basketball App), so this just reads the first row from the
 ...
 */
const FALLBACK_CLUB: Club = { name: 'Sata Basketball App', logoUrl: null }
